...
export function ShapeToolbar({ toolMode, onToolMode, onAddShape, onDragStart, onDeleteSelected, hasSelection }: Props) {
  return (
    <div className="flex items-center gap-1 px-3 py-2 flex-shrink-0 border-b overflow-x-auto"
      ...
      <div className="w-px h-8 flex-shrink-0 mx-1" style={{ background: 'var(--border-subtle)' }} />

      <span className="text-[10px] font-medium flex-shrink-0 mr-1" style={{ color: 'var(--text-tertiary)' }}>SHAPES</span>
