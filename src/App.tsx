...
export default function App() {
  ...
  const shortcuts = useAppShortcuts({ openModal: modalProps.openModal, toggleModal: modalProps.toggleModal, newDiagram, activeTab, handleSave: modalProps.handleSave, toggleFocusMode: modalProps.toggleFocusMode, setSidebarOpen });
  ...
  return (
    <>
      ...
      <ModalProvider
        {...modals}
        onCloseTemplates={modalClose('showTemplates')} onCloseHistory={modalClose('showHistory')} onCloseExport={modalClose('showExport')} onClosePalette={modalClose('showPalette')} onCloseHelp={modalClose('showHelp')} onCloseBackup={modalClose('showBackup')} onCloseSaveTemplate={modalClose('showSaveTemplate')} onCloseAISettings={modalClose('showAISettings')} onCloseFullscreen={modalClose('showFullscreen')}
